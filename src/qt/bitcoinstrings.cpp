...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the emoney Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: emoney.conf)"),
